...
class TestMinkUnet(unittest.TestCase):
    ...
    # @unittest.skip("")
    def test_semantic_kitti_minkunet(self):
        cfg_file = os.path.join('tools', 'cfgs', 'voxel', 'semantic_kitti', 'minkunet_mk34_cr10.yaml')
        # ckpt = cfgs.ROOT_DIR / "model_zoo/download/semkitti_minkunet_mk34_cr16_checkpoint_epoch_36.pth" # 此文件有误
